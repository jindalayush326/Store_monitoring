...
from store.models import Store, BusinessHours, Timezone
...
def import_data():
    ...
    with app.app_context():
        ...
        stores_csv = pd.read_csv('data/store.csv', chunksize=batch_size)
        business_hours_csv = pd.read_csv('data/menu.csv', chunksize=batch_size)
